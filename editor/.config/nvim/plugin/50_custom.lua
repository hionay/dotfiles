...
later(function()
  ...
  nmap_leader("tf", function()
    vim.cmd("!go test -v " .. vim.fn.expand("%:h"))
  end, "[t]est [f]ile")
  ...
  nmap_leader("tv", function()
    vim.cmd("!go test -v ./...")
  end, "[t]est [v]erbose all")
  nmap_leader("tr", function()
    vim.cmd("!go test -race ./...")
  end, "[t]est with [r]ace")
  nmap_leader("tc", function()
    vim.cmd("!go test -coverprofile=" .. vim.fn.getcwd() .. "/coverage.out ./...")
  end, "[t]est [c]overage")
end)
